<?php
/**
 * Класс создан по  php скрипту предоставленному на  http://nicedit.com/
 * В зачади класса входит загрузка картинок на сервер и отправка ответа обратно на JS.
 */
...
END;
  ...
  function nicupload_file_uri($filename){
    return SITE.'/'.NICUPLOAD_URI.'/'.$filename;
  }
