	...
	<table>
		<tr>
			<td class = "im_product_description" >
				<!--a href="<?php echo SITE?>/<?php echo isset($item["category_url"])? $item["category_url"] : 'vse' ?>/<?php echo htmlspecialchars($item["product_url"]) ?>?backurl=<?php echo $item["category_url"] ?>"><?php echo $item["name"] ?></a-->
